...
// database
mongoose.connect(`mongodb+srv://${MONGO_URI}admin:admin@cluster0.os38h.mongodb.net/myFirstDatabase?retryWrites=true&w=majority`, {useNewUrlParser: true, useUnifiedTopology: true})
